  ...
  return (
    ...
    >
      ...
      <header className="flex-none px-8 py-4 flex items-center justify-between" style={{ borderBottom: "1px solid #d6cfc3" }}>
        <span className="text-lg font-bold" style={{ letterSpacing: "0.25em", color: "#0a0a0a" }}>
          TRANSFERAI
        </span>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 space-y-8">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-10">
            <div className="text-center space-y-3">
              <h1 className="text-4xl font-bold" style={{ letterSpacing: "0.1em", color: "#0a0a0a" }}>
                TransferAI
              </h1>
        ...
        {messages.map((msg, i) => (
          <div key={i} className={`flex gap-4 max-w-3xl mx-auto w-full ${msg.role === "user" ? "flex-row-reverse" : "flex-row"}`}>
            <div
              className="flex-none text-xs mt-1 w-8 text-right"
            ...
            <div
              ...
              style={{
                letterSpacing: "0.02em", lineHeight: "1.8", fontFamily: "Georgia, serif",
                padding: "12px 20px",
